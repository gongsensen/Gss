...
import shopcar.adapter.ExpandableListAdapter;
import shopcar.bean.GoodBean;
import shopcar.myview.SmoothCheckBox;
import shopcar.view.UpdateView;

/**
 * Created by lenovo on 2017/11/9.
 */

public class ShopCarFragment extends Fragment implements UpdateView, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.shopcar_frag, container, false);
...
//                }
    ...
    private void initData() {
        ...
        adapter = new shopcar.adapter.ExpandableListAdapter(getActivity(), goodBean);
